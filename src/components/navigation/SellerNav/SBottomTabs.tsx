...
import {Home, ChatRooms, Order, Explore, Pending} from '../../../screens/Seller';
...
const SBottomTabs = ({toggleCameraModal, showCameraModal}: any) => {
  return (
    <Tabs.Navigator
      screenOptions={{
...
export default connect(mapStateToProps, mapDispatchToProps)(SBottomTabs);
