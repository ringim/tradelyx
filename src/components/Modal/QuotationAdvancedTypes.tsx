...
const QuotationAdvancedTypes = ({item, selected, onPress}: any) => {
  return (
    <TouchableOpacity
      style={{
      ...
      <View
        ...
        <Text style={{...FONTS.sh2, color: COLORS.Neutral1}}>
          {item?.label}
        </Text>
        <Text style={{...FONTS.sh3, color: COLORS.Neutral5}}>{item?.text}</Text>
      </View>
...
export default QuotationAdvancedTypes;
