  ...
  return (
    <>
      <MenuView
        ...
        {/* first RFf Air reply */}
        {message?.text ===
          `Hello, I've replied your RFF (Air) request - ${message?.requestTitle}` && (
          <ServiceReplyType
            requestID={message?.rffID}
            title={message?.requestTitle}
            serviceType={message?.serviceType}
            onCopy={() => onCopy(message?.rffID)}
            text={`Hello, I've replied your RFF (Air) request - ${message?.requestTitle}`}
        ...
        {message?.text ===
          `Hello, I've replied your RFF (Land) request - ${message?.requestTitle}` && (
          <ServiceReplyType
            requestID={message?.rffID}
            title={message?.requestTitle}
            serviceType={message?.serviceType}
            onCopy={() => onCopy(message?.rffID)}
            text={`Hello, I've replied your RFF (Land) request - ${message?.requestTitle}`}
            price={message?.requestPrice}
            packageType={message?.packageType}
            qty={message?.requestQty}
            onPress={() =>
        ...
        {message?.text ===
          `Hello, I've replied your RFF (Ocean) request - ${message?.requestTitle}` && (
          <ServiceReplyType
            requestID={message?.rffID}
            title={message?.requestTitle}
            serviceType={message?.serviceType}
            onCopy={() => onCopy(message?.rffID)}
            text={`Hello, I've replied your RFF (Ocean) request - ${message?.requestTitle}`}
            price={message?.requestPrice}
            packageType={message?.packageType}
            qty={message?.requestQty}
            onPress={() =>
        ...
        {message?.text ===
          `Hello, I've replied your RFQ (International) request - ${message?.requestTitle}` && (
          <ServiceReplyType
            requestID={message?.rfqID}
            title={message?.requestTitle}
            serviceType={message?.serviceType}
        ...
        {message?.text ===
          `Hello, I've replied your RFQ (Standard) request - ${message?.requestTitle}` && (
          <ServiceReplyType
            requestID={message?.rfqID}
            title={message?.requestTitle}
            serviceType={message?.serviceType}
            onCopy={() => onCopy(message?.rffID)}
            text={`Hello, I've replied your RFQ (Standard) request - ${message?.requestTitle}`}
            price={message?.requestPrice}
            packageType={message?.packageType}
            qty={message?.requestQty}
            onPress={() =>
        ...
        {message?.text ===
          `Hello, I've replied your RFQ (Domestic) request - ${message?.requestTitle}` && (
          <ServiceReplyType
            requestID={message?.rfqID}
            title={message?.requestTitle}
            serviceType={message?.serviceType}
            onCopy={() => onCopy(message?.rffID)}
            text={`Hello, I've replied your RFQ (Domestic) request - ${message?.requestTitle}`}
            price={message?.requestPrice}
            packageType={message?.packageType}
            qty={message?.requestQty}
            onPress={() =>
        ...
        {message?.text ===
          `Hello, I'm interested in this Product - ${message?.requestTitle}` && (
          <ProductReply
        ...
        {message?.text ===
          `Hello, I'm interested in this Sell Offer - ${message?.requestTitle}` && (
          <SellOfferReply
            imageUri2={message?.serviceImage}
            serviceType={message?.serviceType}
        ...
        {/* Custom sell Offer */}
        {message?.text ===
          `Hello, I've sent a Custom Sell Offer - ${message?.requestTitle}` && (
          <SellOfferReplyType
            imageUri2={message?.serviceImage}
            serviceType={message?.serviceType}
            packageType={message?.packageType}
