...
import {ProgressOrderDetailRouteProp} from '../../../components/navigation/SellerNav/type/navigation';

const ProgressOrderDetail = () => {
      ...
      {status === 'Delivery Update' && (
        <View style={{justifyContent: 'flex-end'}}>
          ...
          <TextButton
            ...
            labelStyle={{...FONTS.h4, color: COLORS.Neutral6}}
            // onPress={handleSubmit(onSubmit)}
          />
        </View>
      )}
...
export default ProgressOrderDetail;
