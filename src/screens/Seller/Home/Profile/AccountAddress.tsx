...
const AccountAddress = () => {
  ...
  const checKNavigation = () => {
    ...
    storeSellerAddress(userAddressCoords?.description?.formatted_address);
  };
  ...
  const storeSellerAddress = async (value: any) => {
    try {
      const jsonValue = JSON.stringify(value);
      await AsyncStorage.setItem('sellerAddress', jsonValue);
    } catch (error) {
      // saving error
      Toast.show({
