  ...
  const checKNavigation = () => {
    ...
    if (isValid) {
      ...
      navigation.navigate({
        ...
        params: {userAddress2: userAddressCoords},
        merge: true,
      });
    }
  };
  ...
  return (
    <AlertNotificationRoot>
      <View
        ...
        <Header title={'Choose Address'} contentStyle={{marginBottom: 0}} tintColor={COLORS.Neutral1}/>
        <AddressPickup
...
export default AirDestinationAddress;
