...
import {
  ...
  SuccessService2RouteProp,
} from '../../../../components/navigation/SellerNav/type/navigation';

const SuccessService2 = () => {
  const navigation = useNavigation<HomeStackNavigatorParamList>();
  const route = useRoute<SuccessService2RouteProp>();
    ...
    <View
      ...
      <View style={{marginTop: SIZES.padding}}>
        <Text
          ...
          Please wait for your offer to be accepted by the buyer. The buyer is
          currently reviewing.
        </Text>
      </View>
...
export default SuccessService2;
