        ...
        <View style={{marginHorizontal: 5}}>
          ...
          <View
            ...
            <View
              ...
              <FastImage
                source={{uri: route?.params?.sellerItem?.placeDestinationFlag}}
                resizeMode={FastImage.resizeMode.contain}
                style={{
                  width: 20,
                  height: 20,
            ...
            <View
              ...
              <Text
                ...
                {route?.params?.sellerItem?.placeDestination}
              </Text>
            </View>
          </View>
          ...
          <View
            ...
            <View
              ...
              <Text style={{...FONTS.sh3, color: COLORS.Neutral5}}>
                {route?.params?.sellerItem?.expiryDate}
              </Text>
            </View>
            <View style={{justifyContent: 'center'}}>
          ...
          <View
            ...
            {route?.params?.sellerItem?.documents?.length === 0 && (
...
export default ReplyDetailInternational;
